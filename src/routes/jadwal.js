...
jadwalRouter.get("/api/jadwal/siswa", authenticate, updateLastActivity, getJadwalSiswa);
jadwalRouter.get("/api/jadwal/siswa/hari-ini", authenticate, updateLastActivity, getJadwalSiswaHariIni);
jadwalRouter.get("/api/jadwal/guru", authenticate, updateLastActivity, getJadwalGuru);
jadwalRouter.get("/api/jadwal/guru/hari-ini", authenticate, updateLastActivity, getJadwalGuruHariIni);
jadwalRouter.get("/api/jadwal/guru/mapel", authenticate, updateLastActivity, getMapelGuru);
