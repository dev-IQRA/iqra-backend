...
router.post('/', upload.single('file'), handleUploadErrors, materiController.createMateri);
...
router.put('/:id', upload.single('file'), handleUploadErrors, materiController.updateMateri);
